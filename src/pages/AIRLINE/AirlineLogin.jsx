...
import { clearAirlineAuthError, fetchAirlineLogin, forgotAirlinePassword } from '../../services/slices/AIRLINE/AirlineAuthSlice';
...
const AirlineLogin = () => {
    ...
    const { error, loading } = useSelector(state => state.airlineAuthSlice)
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const data = { ...formData };
        dispatch(fetchAirlineLogin({ data, navigate }));
    };


    // forgetPassSubmit func.
    const forgetPassSubmit = () => {
        dispatch(forgotAirlinePassword(emailData));
        setEmailData({ email: "" })
    };
    ...
    // console.log(error);
    useEffect(() => {
        dispatch(clearAirlineAuthError())
    }, [dispatch]);
                            ...
                            <div className="card overflow-hidden">
                                ...
                                <div className="card-body pt-0">
                                    ...
                                    <div className="auth-logo">
                                        <Link to="/airline" className="auth-logo-dark">
