...
const VendorDashboard = () => {
    ...
    const filteredData = AIRLINE_DATA?.filter(item => item?._id === user?._airlineId);
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 className="mb-sm-0 font-size-18">Vendor Dashboard</h4>

                                    <div className="page-title-right">
                                        <ol className="breadcrumb m-0">
                                            <li className="breadcrumb-item"><Link to="/vendor">Vendor Dashboard</Link>
                                            </li>
                                    ...
                                    <div className="card-body">
                                        <div className="d-flex">
                                            <div className="flex-grow-1">
                                                <p className="fw-medium">Number of Booking</p>
                                                <div className="d-flex gap-3">
                                                    <div className="vs_one">
                                                        <p style={{ lineHeight: "2px" }}>Today</p>
                                                        <h4 className="mb-2">
                                                            <Link to="#" className="text-info">1234</Link>
                                                        </h4>
                                                    </div>
                                                    <div className='d-flex'>
                                                        <p className='text-info' style={{ lineHeight: "2px" }}>VS</p>
                                                    </div>
                                                    <div className="vs_one">
                                                        <p style={{ lineHeight: "2px" }}>Yesterday</p>
                                                        <h4 className="mb-2">
                                                            <Link to="#" className="text-info">1256</Link>
                                                        </h4>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div className="col-md-3 mb-4">
                                <div className="card mini-stats-wid mb-0 h-100">
                                    <div className="card-body">
                                        <div className="d-flex">
                                            <div className="flex-grow-1">
                                                <p className="fw-medium">Number of Customers </p>
                                                <h4 className="mb-2">
                                                    <Link to="#"> 11357</Link>
                                                </h4>
                            ...
                            <div className="col-md-3 mb-4">
                                <div className="card mini-stats-wid mb-0 h-100">
                                    <div className="card-body">
                                        <div className="d-flex">
                                            <div className="flex-grow-1">
                                                <p className="fw-medium">Revenue</p>
                                                <div className="d-flex gap-3">
                                                    <div className="vs_one">
                                                        <p style={{ lineHeight: "2px" }}>Last Week</p>
                                                        <h4 className="mb-2">
                                                            <Link to="#" className="text-info">₹ 1234</Link>
                                                        </h4>
                                                    </div>
                                                    ...
                                                    <div className="vs_one">
                                                        <p style={{ lineHeight: "2px" }}>This Week</p>
                                                        <h4 className="mb-2">
                                                            <Link to="#" className="text-info">₹ 12560</Link>
                                                        </h4>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex-shrink-0">
                                                <div
                                                    ...
                                                    <span className="avatar-title">
                                                        <i className="fas fa-chart-bar fs-2" style={{ color: "#ffffff" }}></i>
                            ...
                            <div className="col-md-3 mb-4">
                                <div className="card mini-stats-wid mb-0 h-100">
                                    <div className="card-body">
                                        <div className="d-flex">
                                            <div className="flex-grow-1">
                                                <p className="fw-medium">Highest Flight Volume</p>
                                                <div className="d-flex mb-2">
                                                    ...
                                                    <h6 className="my-auto ms-2">
                                                        {filteredData[0]?.airline} <small className="ms-1">6E 377</small>
                                                    </h6>
                                                </div>
