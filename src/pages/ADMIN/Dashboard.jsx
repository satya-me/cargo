                            ...
                            <div className="col-md-3 mb-4">
                                <div className="card mini-stats-wid mb-0 h-100">
                                    <div className="card-body">
                                        <div className="d-flex">
                                            <div className="flex-grow-1">
                                                <p className="fw-medium">Airline Achiever</p>
                            ...
                            <div className="col-md-3 mb-4">
                                <div className="card mini-stats-wid mb-0 h-100">
                                    <div className="card-body">
                                        <div className="d-flex">
                                            <div className="flex-grow-1">
                                                <p className="fw-medium">Flight & Destination
                                                </p>
                                                <div className="d-flex mb-2">
                                                    <img src="/assets/imgs/I5.png" className="rounded-circle"
                                                        style={{ width: "28px" }} alt='' />
                                                    <h6 className="my-auto ms-2">
                                                        AirAsia <small className="ms-1">6E 377</small>
                                                    </h6>
                                                </div>
                                                <small className="text-muted">Highest for this week</small>
                                            </div>
