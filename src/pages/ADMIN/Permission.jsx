                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 className="mb-sm-0 font-size-18"> Airline Permission</h4>

                                    <div className="page-title-right">
                                        <ol className="breadcrumb m-0">
                                            <li className="breadcrumb-item"><Link to="/">Dashboard</Link>
                                            </li>
                                            <li className="breadcrumb-item active"> Airline Permission</li>
                                        </ol>
                                    </div>
                                        ...
                                        <table className="table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th className="text-center">Basic Reporting</th>
                                                    <th className="text-center">Advance Reporting</th>
                                                    <th className="text-center">Predictive Analytics</th>
